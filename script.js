...
const translations = {
    en: {
        ...
        project4Desc: 'Analyzing and Predicting Customer Default Risk Using Python and Power BI to Reduce Non-Performing Loan Rates.',
    ...
    vi: {
        ...
        project4Desc: 'Phân tích dự đoán rủi ro khả năng vỡ nợ của khách hàng bằng Python và Power BI để giảm tỷ lệ nợ xấu.',
